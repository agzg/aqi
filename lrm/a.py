...
x_train = np.array(list(tempvsaqi.keys()), dtype=np.float64)
y_train = np.array(list(tempvsaqi.values()), dtype=np.float64)
# a, b = np.polyfit(list(tempvsaqi.keys()), list(tempvsaqi.values()), 1)
